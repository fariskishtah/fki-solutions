...
export const metadata: Metadata = { title: "Contact", description: "Start a conversation with FK Solutions about an AI product, custom software, automation, or partnership." };
